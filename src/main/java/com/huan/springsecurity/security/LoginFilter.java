...
/**
 * 自定义filter，用于登录时的拦截判断
 * 
 * @描述
 * @作者 huan
 * @时间 2017年6月10日 - 上午10:06:49
 */
public class LoginFilter extends AbstractAuthenticationProcessingFilter {
	 ...
	 * <p>
	 * This might be used for example if a postcode/zipcode was required in addition to the password. A delimiter such as a pipe (|) should be used to separate the password and extended value(s). The <code>AuthenticationDao</code> will need to generate the expected password in a corresponding manner.
	 * </p>
	 *
	 * @param request
